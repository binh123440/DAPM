...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 01, 2024 lúc 03:27 PM
...
('0001', 'Nguyễn Quang Thọ', '1975-07-05', 0, '0914030651', 'sdadas@gmail.com', 0, '12345@@@', 'avt/24/Screenshot_2024-05-31_191216_j4tTy91.png');
...
('CTSV001', 'Nguyễn Tấn Hòa', '1975-07-05', 0, '0914030651', 'nthoa@ute.udn.vn', 0, 'CTSV-NTH@', 'avt/24/Screenshot_2024-05-31_191216_7D3Atm2.png'),
('CTSV002', 'Nguyễn Tấn Hòa', '1975-07-05', 1, '0914030651', 'sdadas@gmail.com', 1, 'CTSV-NTH@', 'avt/24/Screenshot_2024-05-31_191216_D7PMprI.png');
...
('21115053120138', 'La Thế Quyền', '2003-07-02', 0, '066203002013', 'EaNam - EaHleo - Đắk Lắk', '0867089934', 'thequyenla@gmail.com', '21T1', 'Công nghệ thông tin', 'Công nghệ số', '2021', 'Kinh', '12345@', 'img/24/Screenshot_2024-05-31_191216.png'),
...
(1, 'pbkdf2_sha256$720000$3Su0dnsorg13lNtEGD6gN2$SK0HA1WLkWTncWRm5WNQ+GJGiypf1+0l0qOm9M52SPU=', '2024-05-21 19:58:52.047418', 1, 'lathequyen', '', '', 'quyenlathe4@gmail.com', 1, 1, '2024-05-21 19:58:41.114729');
...
(1, 'admin', 'logentry'),
(8, 'app_thongtinPCTSV', 'daidienphongban'),
(9, 'app_thongtinphongban', 'daidienphongban'),
...
--
-- Chỉ mục cho bảng `app_thongtinphongbgh_bangiamhieu`
--
ALTER TABLE `app_thongtinphongbgh_bangiamhieu`
  ADD PRIMARY KEY (`MNV`),
  ADD UNIQUE KEY `app_thongtinphongBGH_bangiamhieu_Email_da4bfd5d_uniq` (`Email`);
...
ALTER TABLE `app_thongtinphongctsv_phongctsv`
  ADD PRIMARY KEY (`MNV`),
  ADD UNIQUE KEY `app_thongtinphongCTSV_phongctsv_Email_00986c08_uniq` (`Email`);
